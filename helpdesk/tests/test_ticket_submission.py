...
class MailBasicsTestCase(TicketBasicsTestCase):
    fixtures = ['emailtemplate.json']
    ...
    def setUp(self):
        ...
        self.queue_public_with_notification_enabled = Queue.objects.create(title='Queue 3', 
                                                                            slug='q3', 
        ...
        self.queue_public_with_notification_disabled = Queue.objects.create(title='Queue 4', 
                                                                            slug='q4', 
                                                                            allow_public_submission=True, 
