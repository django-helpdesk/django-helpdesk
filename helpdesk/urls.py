...
urlpatterns = [
    ...
    url(r'^tickets/(?P<ticket_id>[0-9]+)/$',
        staff.view_ticket,
        name='view'),
    url(r'^tickets/(?P<ticket_id>[0-9]+)/quick_comment$',
        staff.edit_quick_comment,
        name='edit_quick_comment'),
    ...
    url(
        r'^generic_incidents/(?P<generic_incident_id>[0-9]+)/$',
        staff.generic_incident_detail,
